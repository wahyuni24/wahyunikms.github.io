                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      ...
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img class="img-responsive avatar-view" src="<?php echo base_url();?>photo/images/<?php echo $user['userfile'];?>"alt="Avatar" title="Change the avatar">
                          <!-- Loading state -->
                      ...
                      <h2>Nama &nbsp; : &nbsp;<?php echo $user['nama'];?></h2>
                      <h2>NIP &nbsp; &nbsp; &nbsp; &nbsp; : &nbsp;<?php echo $user['nip'];?></h2>
                      <h2>Status &nbsp; : &nbsp;<?php if($user['hak_akses']  ==  '1'){ echo "Pegawai";}?>
                        <?php if($user['hak_akses']  ==  '4'){ echo "Tenaga Ahli";}?>                        
                      </h2><br>
                      <br>
                        <a href="<?php echo base_url('control/edit_profil');?>" button class="btn btn-outline-succes btn-success"><i class="fa fa-edit m-right-xs"></i> Edit Profil</a>
                    </div>
                      ...
                      <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          <li role="presentation" class="active">
                            <a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Tacit Knowledge
                            </a>
                          </li>

    ...
    <?php foreach($solusi->result_array() as $data)?>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <form action="<?php echo base_url();?>control/update_solusi" method="post" enctype="multipart/form-data">
              ...
              <div class="col-md-8 col-sm-6 col-xs-12">
                <div class="x_panel fixed_height_10 ">
                  ...
                  <div class="x_content">
                    <textarea id="editor1" name="solusi_masalah" rows="10" cols="80"><?php echo $data['solusi_masalah'];?></textarea>

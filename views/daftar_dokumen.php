                    ...
                    <table id="example1" class="table table-striped table-bordered">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a target="_blank" href="<?php echo base_url('control/detail_dokumen');?>/<?php echo $data['id_explicit'];?>">
                          ...
                          <td><center>
                            <a onClick="return confirmSubmit()" href="<?php echo base_url('control/validasi_explicit');?>/<?php echo $data['id_explicit'];?>/<?php echo $data['id_pengguna'];?>">
